...
namespace kxdanmuji.Controls {
    public class KxWindow : Window {
            ...
            set {
                ...
                switch (value) {
                    case SkinTypeEnum.Dark:
                        r.Source = new Uri("kxdanmuji;component/Themes/KxWindow.Dark.xaml", UriKind.Relative);
                        this.Resources.MergedDictionaries.Add(r);
                        break;
                    case SkinTypeEnum.Blue:
                        r.Source = new Uri("kxdanmuji;component/Themes/KxWindow.Blue.xaml", UriKind.Relative);
                        this.Resources.MergedDictionaries.Add(r);
                        break;
                    case SkinTypeEnum.Image:
                        r.Source = new Uri("kxdanmuji;component/Themes/KxWindow.Image.xaml", UriKind.Relative);
                        this.Resources.MergedDictionaries.Add(r);
                        break;
                }
                mSkinType = value;
        ...
        /// </summary>  
        public KxWindow() {
            mWindowResouce.Source = new Uri("kxdanmuji;component/Themes/KxWindow.Base.xaml", UriKind.Relative);
            this.Resources.MergedDictionaries.Add(mWindowResouce);
